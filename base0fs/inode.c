...
extern dev_t sProcDev;
extern dev_t sDevDev;
extern dev_t sSysDev;
...
STATIC int
base0fs_inode_revalidate(struct dentry *dentry)
{
        int err = 0;
        struct dentry *lower_dentry;
        inode_t *lower_inode;
        ...
        //    fist_print_dentry("base0fs_inode_revalidate IN", dentry);
        ...
        */
        ...
        //    fist_print_dentry("base0fs_inode_revalidate OUT", dentry);
        print_exit_status(err);
        return err;
}
...
base0fs_setxattr(struct dentry *dentry, const char *name, const void *value,size_t size, int flags)
...
struct inode_operations base0fs_symlink_iops =
{
        readlink:   base0fs_readlink,
        follow_link: base0fs_follow_link,
	put_link: base0fs_put_link,
        permission: base0fs_permission,
        //revalidate: base0fs_inode_revalidate,
        setattr:    base0fs_setattr,

        setxattr:   base0fs_setxattr,
        getxattr:   base0fs_getxattr,
        listxattr:  base0fs_listxattr,
        removexattr: base0fs_removexattr
};

struct inode_operations base0fs_dir_iops =
{
        create: base0fs_create,
        lookup: base0fs_lookup,
        link:   base0fs_link,
        unlink: base0fs_unlink,
        symlink:    base0fs_symlink,
        mkdir:  base0fs_mkdir,
        rmdir:  base0fs_rmdir,
        mknod:  base0fs_mknod,
        rename: base0fs_rename,
        /* no readlink/follow_link for non-symlinks */
        // no truncate because we have setattr
        permission: base0fs_permission,
        //revalidate: base0fs_inode_revalidate,
        setattr:    base0fs_setattr,
        setxattr:   base0fs_setxattr,
...
struct inode_operations base0fs_main_iops =
{
        permission: base0fs_permission,
        //revalidate: base0fs_inode_revalidate, //XXX: Revalidate is GONE
        setattr:    base0fs_setattr,
        setxattr:   base0fs_setxattr,
        getxattr:   base0fs_getxattr,
        listxattr:  base0fs_listxattr,
