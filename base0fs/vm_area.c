 ...
 */
struct vm_operations_struct base0fs_shared_vmops = {
        open:      base0fs_vm_open,
        close:     base0fs_vm_close,
        unmap:     base0fs_vm_shared_unmap,
        sync:      filemap_sync,
 ...
 */
struct vm_operations_struct base0fs_private_vmops = {
        nopage:    filemap_nopage,
};
#endif /* NOT_NEEDED */
